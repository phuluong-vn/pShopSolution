    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("b0eeed3d-5092-4789-a760-e252aa217e3c"), "a4aa12be-b5bf-4ac0-9187-887d9f37725e", "Administrator role", "admin", "admin" });

            migrationBuilder.InsertData(
                table: "AppUser",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Dob", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("30dcd73b-c849-44ac-bca3-e48e2843691b"), 0, "0e5e9081-46ba-4093-96c3-197384d21eaa", new DateTime(2020, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "phuluong2019@gmail.com", true, "Phú", "Lương", false, null, "phuluong2019@gmail.com", "admin", "AQAAAAEAACcQAAAAEDecj4Rg7HZduzgF6gKXu1FlZVECXgeF81pS/v+C7Zx+NUMHEEe799Edw2C+MPabKw==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 12, 2, 16, 22, 12, 430, DateTimeKind.Local).AddTicks(5888), 100000m, 200000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi", "Áo nam", "ao-nam", "Sản phẩm thời trang áo nam", "Sản phẩm thời trang áo nam" },
                    { 3, 2, "vi", "Áo nữ", "ao-nu", "Sản phẩm thời trang áo nam", "Sản phẩm thời trang áo nu" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Sản phẩm thời trang áo sơ mi nam Việt Tiến", "Sản phẩm thời trang áo sơ mi nam Việt Tiến", "vi", "Áo sơ mi nam Việt Tiến", 1, "ao-so-mi-nam-Viet-Tien", "Sản phẩm thời trang áo sơ mi nam Việt Tiến", "Sản phẩm thời trang áo sơ mi nam Việt Tiến" },
                    { 2, "The Viet Tien t-shirt product for men", "The Viet Tien t-shirt product for men", "en", "Viet Tien Men T-Shirt", 1, "viet-tien-men-t-shirt", "The Viet Tien shirt product for men", "The Viet Tien shirt product for men" }
                });
